...
پس از اجرای جیمیتر صفحه‌ای مشابه شکل زیر نمایش داده میشود که شامل یک Test Plan می‌باشد. Test Plan کامپوننت اصلی جیمیتر است، در واقع مانند ظرفی است که شامل المان‌های مورد نیاز برای اجرای تست می‌باشد و جریان تست بار شما را نمایش می‌دهد. یک Test Plan کامل از یک یا چند المان مانند Thread Group ،Logic Controllers، Samplers، Listeners، Timers، Assertions و Configuration Elements تشکیل می‌شود. در نظر داشته باشید که هر Test Plan باید حداقل یک Thread Group داشته باشد.
